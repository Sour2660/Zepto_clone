...
const Footer = () => {
  return (
    <div className="zepto-footer mt-5 pt-4 pb-5" style={{ background: "#fafafa", fontSize: "14px" }}>
      <Container>
        ...
        <div className="border-top pt-4">
          <h6 className="fw-bold">Popular Searches</h6>
          <div className="mb-2"><strong>Products</strong>: {" "} <span className="text-muted small"> Avocado | Strawberry | Beetroot | Potato | Lemon | Blueberry | Papaya | Dragon fruit </span> </div>
          <div className="mb-2"><strong>Brands</strong>: Yakult | Amul | Aashirvaad Atta | Fortune Oil | Nandini Milk | Mother Dairy</div>
          <div><strong>Categories</strong>: Grocery | Curd | Cheese slice | Fresh fruits | Eggs price | Paan shop near me</div>
        </div>
  ...
  <div className="d-flex gap-4 mt-2">
   ...
   <p className="small mt-2 text-muted">©Zepto Clone  Sourabh Basarikatti </p> 
</div>
          ...
          <Row className="w-100 mt-3">
            <Col sm={6} md={3}>
              ...
              <ul className="list-unstyled text-muted small">
                ...
                {/* <li>Delivery Areas</li> */}
                 <li><a href="https://www.zepto.com/del-areas" target="_blank" rel="noopener noreferrer" className="text-muted text-decoration-none">Delivery Areas</a></li>
                {/* <li>Careers</li> */}
                      <li><a href="https://zepto.talentrecruit.com/career-page" target="_blank" rel="noopener noreferrer" className="text-muted text-decoration-none">Careers</a></li>
                {/* <li>Customer Support</li> */}
                 <li><a href="https://www.zepto.com/customer-support" target="_blank" rel="noopener noreferrer" className="text-muted text-decoration-none">Customer Support</a></li>
                {/* <li>Press</li> */}
                 <li><a href="https://www.zepto.com/press" target="_blank" rel="noopener noreferrer" className="text-muted text-decoration-none">Press</a></li>
              </ul>
            </Col>
            <Col sm={6} md={3}>
              <p className="fw-bold">Legal</p>
              <ul className="list-unstyled text-muted small">
                {/* <li>Privacy Policy</li> */}
                 <li><a href="https://www.zepto.com/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-muted text-decoration-none">Privacy Policy</a></li>
                {/* <li>Terms of Use</li> */}
                <li><a href="https://www.zepto.com/terms-of-service" target="_blank" rel="noopener noreferrer"   className="text-muted text-decoration-none">Terms of Use</a></li> 
                {/* <li>Responsible Disclosure</li> */}
                <li><a href="https://www.zepto.com/responsible-disclosure-policy" target="_blank" rel="noopener noreferrer"  className="text-muted text-decoration-none">Responsible Disclosure</a></li>
                {/* <li>Mojo - Zepto Blog</li> */}
                 <li><a href="https://blog.zeptonow.com/" target="_blank" rel="noopener noreferrer" className="text-muted text-decoration-none">Mojo - Zepto Blog</a></li>
                {/* <li>Sell on Zepto</li> */}
                <li><a href="https://brands.zepto.co.in/zepto" target="_blank" rel="noopener noreferrer"  className="text-muted text-decoration-none">Sell on Zepto</a></li>
              </ul>
            </Col>
            <Col sm={12} md={3}>
  <p className="fw-bold">Download App</p>
  <div className="d-flex flex-column gap-2">
    ...
    <a
      ...
      rel="noopener noreferrer"
    >
      <img src="/icons/app-store.png" alt="App Store" style={{ height: "100px", width: '300px' }} />
    </a>
  </div>
</Col>
